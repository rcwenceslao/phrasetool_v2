                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">List Languages</li>
                                        </ul>
                                    </div>
                                    <!--
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <?php
                                                    echo $result['sprache_id'];
                                                ?>
                                            </div>
                                            <div class="col-md-6">
                                                2-Letter ISO-Code (639-1)
                                            </div>
                                            <div class="col-md-6">
                                                <?php
                                                    echo $result['sprache_iso2'];
                                                ?>
                                            </div>
                                            <div class="col-md-6">
                                                3-Letter ISO-Code (639-3)
                                            </div>
                                            <div class="col-md-6">
                                                 <?php
                                                    echo $result['sprache_iso3'];
                                                ?>
                                            </div>
                                            <div class="col-md-6">
                                                4-Letter ISO-Code (639-6)
                                            </div>
                                            <div class="col-md-6">
                                                 <?php
                                                    echo $result['sprache_iso4'];
                                                ?>
                                            </div>
                                             <div class="col-md-6">
                                               Priority
