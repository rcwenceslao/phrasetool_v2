...
if (isset($_POST['editBtn'])) {
    ...
    $result = $pt->selectLanguageCodeInfo($uid);
...
if (isset($_POST['updateLanguageCode']) && $_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $languageCode = test_input($_POST["languageCode"]);
  $sprachenkuerzel_id = test_input($_POST["sprachenkuerzel_id"]);
  $uid = (int)$sprachenkuerzel_id;
  

   $languageCode_fields = [   
            'sprache_id'=>$language,
            'firma_id'=>$company,
            'sprache_kurz'=>$languageCode
    ];
        
         
    $pt->updateLanguageCode($languageCode_fields,$uid);
...
<body class="animsition">
 ...
 -->
            ...
            <center>
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">Edit Language</div>
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div class="row form-group">
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="col-12 col-md-12">
                                                                ...
                                                                <option value="<?php echo $result['CompanyId'];  ?>" selected><?php echo $result['company'];  ?></option>
                                                                     <?php
                                                             $pt = new Phrasetool();
                                                   ...
                                                   echo '<input type="text"  name="sprachenkuerzel_id" placeholder="" class="form-control" value="'.$result['sprachenkuerzelId'].'" hidden>';
                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="col-12 col-md-12">
                                                                <select name="language" id="select" class="form-control" >
                                                                    <option value="<?php echo $result['languageId'];  ?>" selected><?php echo $result['language'];  ?></option>
                                                                    <?php
                                                             $pt = new Phrasetool();
                                                                $rows = $pt->selectLanguage();
                                                                     foreach ($rows as $row) 
                                                                        {
                                                         ?>
                                                                     <option  value="<?php echo $row['languageId']; ?>"><?php echo $row['language']; ?> </option>
                                                ...
                                                <div class="col col-md-12">
                                                    <br>
                                                    Language Code <i style="color: red;">*</i><br>
                                                    <div class="input-group">
                                                        <input type="text" id="input1-group2" name="languageCode" placeholder="" class="form-control" value="<?php echo $result['languageCode']; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-success btn-sm" name="updateLanguageCode">
