                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <?php
                                            $pt = new Phrasetool();
                                             $rowCount = $pt->returnLaguagesRowCount(); //return number of rows in db
                                            ...
                                            $rows = $pt->displayLanguages($rowPerPage,$startingLimitNumber);
                                            foreach ($rows as $row) 
                                            {
                                     ...
                                     <div class="text-center">
                                        ...
                                        <?php
                                            ...
                                            {
                                                echo '<li><a href = "language_landing.php?page='.$page.'">'. $page .'</a></li>';
                                            }
                                        ?>
                                    </ul>
                                    </div>
