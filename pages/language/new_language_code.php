...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $languageCode = test_input($_POST["languageCode"]);
   ...
   $languageCode_fields = [   
         ...
         $pt = new Phrasetool();
       $pt->insertLanguageCode($languageCode_fields);
...
-->
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="copy_language_codes.html">
...
-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">New Language Code</li>
                                        </ul>
                                    </div>
                                    <!--
            ...
            <center>
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">New Language Code</div>
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div class="row form-group">
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="col-12 col-md-12">
                                                                <select  id="select" class="form-control" name="language">
                                                                    <?php
                                                             $pt = new Phrasetool();
                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="col-12 col-md-12">
                                                                <select  id="select" class="form-control" name="company">
                                                                     <?php
                                                             $pt = new Phrasetool();
                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" id="input1-group2" name="languageCode" placeholder="" class="form-control" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-success btn-sm" name="addLanguageCode">
