...
if(isset($_GET['read']))
{
    ...
    $result = $pt->viewLanguageCode($uid);
}
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">List Language Code</li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">View Language Code</li>
                                        </ul>
                                    </div>
                                    <!--
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <?php
                                                echo $result['sprachenkuerzel_id'];
                                                ?>
                                            </div>
                                            <div class="col-md-6">
                                               Company
