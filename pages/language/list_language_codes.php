            ...
            <center>
                <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form action="edit_language_code.php" method="post">
                                    <div class="card-header">
                                   ...
                                   <div class="card-body card-block">
                                       <div class = "task-progress">
                                        ...
                                        <tr>
                                        <th scope="row"><?php echo $row['languageName']; ?></th>
                                        <td><?php echo $row['companyName']; ?></td>
                                        <td><?php echo $row['languageCode']; ?></td>
                                        <td><button type="submit" class="btn btn-sm btn-outline-primary" name="editBtn" value="<?php echo $row['sprachenkuerzelId']; ?>">Edit</button>&nbsp;<a class="btn btn-sm btn-outline-danger" href=""><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;Delete</a>&nbsp;<a  class="btn btn-sm btn-outline-success" href="view_language_code.php?read=<?php echo $row['sprachenkuerzelId']; ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;View</a></td>
                                        </tr>
