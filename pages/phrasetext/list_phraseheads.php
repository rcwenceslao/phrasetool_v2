...
-->
            ...
            <center>
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>List Phraseheads </strong>
                                   </div>
                ...
                <form action="edit_phrasehead.php" method="post">                    
                  ...
                  <thead>
                    <tr>
                      <th scope="col" class="table-warning">Phrasehead</th>
                      <th scope="col" class="table-warning">Phrasecatalogue</th>
                      <th scope="col" class="table-warning">Phrasegroup</th>
                      <th scope="col" class="table-warning">PhraseId</th>
                  ...
                  <tbody>
                    ...
                    ?>
                            ...
                            <tr>
                            <th scope="row"><?php echo $row['phrasenkopf_id']; ?></th>
