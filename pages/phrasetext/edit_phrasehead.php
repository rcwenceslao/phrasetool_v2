...
if (isset($_POST['phraseheadEditBtn'])) {
    $pt = new Phrasetool();
    $uid  = $_POST['phraseheadEditBtn'];
   
    $result = $pt->selectPhraseheadInfo($uid);
...
if (isset($_POST['updatePhrasehead']) && $_SERVER["REQUEST_METHOD"] == "POST") {

    $pt = new Phrasetool();
    //$uid = $pt->getID();
   // $uid = (int)$uid;
  
  $phraseCatalogue = test_input($_POST["phraseCatalogue"]);
  $phraseGroup = test_input($_POST["phraseGroup"]);
  $phraseId = test_input($_POST["phraseId"]);
  $commercialPhrase = test_input($_POST["commercialPhrase"]);
  $releasedPhrase = test_input($_POST["releasedPhrase"]);
  $euphracPhrase = test_input($_POST["euphracPhrase"]);
  $structureCode = test_input($_POST["structureCode"]);
  $originalCode = test_input($_POST["originalCode"]);
  $timestampMonth = test_input($_POST["timestampMonth"]);
  $timestampDay = test_input($_POST["timestampDay"]);
  $timestampYear = test_input($_POST["timestampYear"]);
  $timestampHour = test_input($_POST["timestampHour"]);
  $timestampMinutes = test_input($_POST["timestampMinutes"]);
  $timestampMeridiem = test_input($_POST["timestampMeridiem"]);

  $phrasehead_id = test_input($_POST["phrasehead_id"]); 
  $uid = (int)$phrasegroup_id;
//////////////////////////////////////////////////////////////////////////////

$timestampHourTemp="";
  if($timestampMeridiem == 2)
{
    if($timestampHour == 12)
    {
        $timestampHourTemp = $timestampHour;
    }
    else
    {
        $timestampHourTemp = (int)$timestampHour + 12;
    }
...
/////////////////////////////////////////////////////////////
  ...
  if(strlen($timestampDay) == 1 || strlen($timestampHourTemp) == 1 || strlen($timestampMinutes ) == 1)
  {
    $temp="0";
  }
  else
...
$timestampDay = $temp.$timestampDay;
$timestampHour = $temp.$timestampHourTemp;
$timestampMinutes  = $temp.$timestampMinutes;

$timestamp = $timestampYear.'-'.$timestampMonth.'-'.$timestampDay.' '.$timestampHour.':'.$timestampMinutes.':00';


  

   $phrasehead_fields = [   
            'phrasenkatalog_id'=>$phraseCatalogue,
            'phrasengruppe_id'=>$phraseGroup,
            'phrasenid'=>$phraseId,
            'kommerziell'=>$commercialPhrase,
            'freigegeben'=>$releasedPhrase,
            'euphrac_phrase_id'=>$euphracPhrase,
       ...
       $pt->updatePhrasehead($phrasehead_fields,$uid);
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div class="row form-group">
                                                <div class="col col-md-6">
                                                    ...
                                                    <input type="hidden" name="phraseCatalogueId">
                                                    <select class="custom-select custom-select-lg mb-3" name="phraseCatalogue">
                                                        <option value="<?php echo $result['phrasenkatalog_id']; ?>" selected ><?php echo $result['katalog_pin']; ?></option>
                                                        <?php
                                                             $pt = new Phrasetool();
                                                                $rows = $pt->selectPhraseKatalog();
                                                                     foreach ($rows as $row) 
                                                                        {
                                                         ?>
                                                                     <option value="<?php echo $row['phrasecatalogId']; ?>"><?php echo $row['catalogPin']; ?> </option>
                                                ...
                                                <?php
                                            echo '<input type="text"  name="phrasehead_id" placeholder="" class="form-control" value="'.$result['phrasenkopf_id'].'" readonly>';
                                            ?>
                                                ...
                                                <div class="col col-md-6">
                                                    ...
                                                    <select class="custom-select custom-select-lg mb-3" name="phraseGroup">
                                                       <option value="<?php echo $result['phrasengruppe_id']; ?>" selected><?php echo $result['phrasengruppe']; ?></option>

                                                        <?php
                                                             $pt = new Phrasetool();
                                                                $rows = $pt->selectPhrasegroup();
                                                                     foreach ($rows as $row) 
                                                                        {
                                                         ?>
                                                                     <option value="<?php echo $row['phrasegroupId']; ?>"><?php echo $row['phrasegroup']; ?> </option>
                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" id="input1-group2"  class="form-control" value="<?php echo $result['phrasenid']; ?>" name="phraseId">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1" class="form-check-label ">
                                                                <BR><BR>
                                                                <?php 
                                                                $commercial = $result['kommerziell'];
                                                                if($commercial == 0)
                                                                {
                                                                   echo '<input type="checkbox" id="checkbox1" name="commercialPhrase" 
                                                                value="0" class="form-check-input">Commercial Phrase<i style="color:red;">*</i>';
                                                                }
                                                                else
                                                                {
                                                                    echo '<input type="checkbox" id="checkbox1" name="commercialPhrase" 
                                                                value="1" class="form-check-input" checked>Commercial Phrase<i style="color:red;">*</i>';
                                                                }
                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <label for="checkbox1" class="form-check-label ">
                                                                ...
                                                                $released = $result['freigegeben'];
                                                                if($released == 0)
                                                                {
                                                                   echo '<input type="checkbox" id="checkbox1" name="releasedPhrase" value="0" class="form-check-input" >Released Phrase<i style="color:red;">*</i>';
                                                                   

                                                                }
                                                                else
                                                                {
                                                                    echo '<input type="checkbox" id="checkbox1" name="releasedPhrase" value="1" class="form-check-input" checked>Released Phrase<i style="color:red;">*</i>';
                                                ...
                                                <div class="col col-md-6">
                                                    ...
                                                    Euphrac Phrase <br>
                                                    <div class="input-group">
                                                        <input type="text" id="input1-group2" name="euphracPhrase"  class="form-control" value="<?php echo $result['euphrac_phrase_id']; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col col-md-6">
                                                    ...
                                                    Structuure Code <br>
                                                    <div class="input-group">
                                                        <input type="text" id="input1-group2" name="structureCode"  class="form-control" value="<?php echo $result['structure_code']; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col col-md-6">
                                                    ...
                                                    Original Code <br>
                                                    <div class="input-group">
                                                        <input type="text" id="input1-group2" name="originalCode"  class="form-control" value="<?php echo $result['original_code']; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="col-12 col-md-12">
                                                                <select name="timestampMonth" id="select" class="form-control">
                                                                    <option selected><?php
                                                    ...
                                                    <div class="btn-group">
                                                            <div class="col-12 col-md-12">
                                                                <select name="timestampDay" id="select" class="form-control">
                                                                    <option selected><?php

                                                                      $date = date('d', strtotime($result['zeitstempel']));
                                                                     echo $date;
                                                                     ?></option>
                                                                    <?php
                                                    ...
                                                    <div class="btn-group">
                                                            <div class="col-12 col-md-12">
                                                                <select name="timestampYear" id="select" class="form-control">
                                                                    <option selected><?php

                                                                      $date = date('Y', strtotime($result['zeitstempel']));
                                                                     echo $date;
                                                                     ?></option>
                                                                    <?php
                                                    ...
                                                    <div class="btn-group">
                                                            <div class="col-12 col-md-12">
                                                                <select name="timestampHour" id="select" class="form-control">
                                                                    <option selected><?php

                                                                      $date = date('h', strtotime($result['zeitstempel']));
                                                                     echo $date;
                                                                     ?></option>
                                                                    <?php
                                                    ...
                                                    <div class="btn-group">
                                                            <div class="col-12 col-md-12">
                                                                <select name="timestampMinutes" id="select" class="form-control">
                                                                    <option selected><?php

                                                                      $date = date('i', strtotime($result['zeitstempel']));
                                                                     echo $date;
                                                                     ?></option>
                                                                    <?php
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="col-12 col-md-12">
                                                                <select name="timestampMeridiem" id="select" class="form-control">
                                                                    <option selected><?php

                                                                      $date = date('a', strtotime($result['zeitstempel']));
                                                                     echo $date;
                                                                     ?></option>
                                            ...
                                            <button type="submit" class="btn btn-success btn-sm" name="updatePhrasehead">
