                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">List Phraseheads</li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">View Phrasehead</li>
                                        </ul>
                                    </div>
                                    <!--
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="phraseHead" readonly="" value="<?php echo $result['phrasenkopf_id']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                Phrasecatalogue
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="phraseCatalogue" readonly="" 
                                                value="<?php echo $result['katalog_pin']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                Phrasegroup
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="phraseGroup" readonly="" value="<?php echo $result['phrasengruppe']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                PhraseId
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="phraseId" readonly="" value="<?php echo $result['phrasenid']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                Commercial Phrase
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="phraseCommercialPhrase" readonly="" 
                                                value="<?php 
                                                $commercialPhrase = "";
                                                if ($result['kommerziell'] == 0)
                                                {
                                                    $commercialPhrase = "No";
                                                    echo $commercialPhrase;
                                                }
                                                else
                                                {
                                                    echo $result['kommerziell']; 
                                                }
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="releasedPhrase" readonly="" 
                                                value="<?php 
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="euphracPhraseId" readonly="" value="<?php echo $result['euphrac_phrase_id']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                Structure Code
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="structureCode" readonly="" value="<?php echo $result['structure_code']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                Original Code
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="originalCode" readonly="" value="<?php echo $result['original_code']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                Timestamp
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="timestamp" readonly="" value="<?php echo $result['zeitstempel']; ?>">
                                            </div>
                                            <div class="col-md-6">
                                                Actions
                                            </div>
                                            <div class="col-md-6">
                                                <div style="margin-left:2em; margin-top:-0.1em; padding-left:1em;">
                                                    <button type="button" class="btn btn-warning btn-sm"><a style="color: black;" href="edit_phrasehead.php">Edit</a></button>
                                                    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#deletePhraseHead">Delete</button>
                                                    <button type="button" class="btn btn-warning btn-sm"><a style="color: black;" href="phrase_set_translation.html">Translation of Phraseheads</a></button>
                                                </div>
                                            </div>
                                        </div>
