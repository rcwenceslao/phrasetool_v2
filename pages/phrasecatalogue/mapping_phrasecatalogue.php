...
<head>
    ...
    <!-- Title Page-->
    <title>Phrasecatalogue Mapping</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">MAPPING OF CATALOGUES</li>
                                        </ul>
                                    </div>
                                    <!--
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="statistic__item">
                                    ...
                                    <h2>MAPPING OF CATALOGUES</h2>
                                    <br>
                                    The origin catalogue "[katalog_pin]" (#id) will be mapped agaisnt the selected target catalogue:
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class = "task-progress">
                                    <form class="form-horizontal" action="#">
                                        ...
                                        <?php
                                            $pt = new Phrasetool();
                                            $rows = $pt->selectPhraseCataloguePin();
                                       ...
                                       <div class="form-group">
                                          <label class="control-label col-sm-2" for="targetcatalogue"><b>Target Catalogue:</b></label>
                                          <div class="col-sm-12">          
                                            <select class= "form-control" name="targetcatalogue" id="targetcatalogue">

                                                <?php
                                                    foreach($rows as $row)
                                                    {
                                                        echo "<option value=".$row['phrasenkatalog_id'].">".$row['katalog_pin']."</option>";
                                                    }
                                                ?>
                                                
                                            </select>

                                            <font size="2"> <i>Select your catalogue you want to map the other catalogue with.</i>  </font>
                                           </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="rewritephrasesets"> <b> Compare only non-mapped Phrases</b></label>
                                              <br>
                                              <font size="2"> <i>Only those Phrases will be mapped which are not referenced to the target catalogue.</i>  </font>
                                              <br><br>
                                              <label><input type="checkbox" value="rewritespecialdata"> <b>Retrict to same Structure Code</b></label>
                                              <br>
                                              <font size="2"> <i>The system will only use phrases wi the same structure code in the mappingprocess. A structure code must be set on both catalogugedata. This is useful to compare two versions of the same catalogue.</i>  </font>
                                              <label><input type="checkbox" value="rewritespecialdata"> <b>Restrict to same Group</b></label>
                                              <br>
                                              <font size="2"> <i>The system will only use phrases with the same phrasegroup in the mapping process. This is useful to compare two versions of the same catalogue or similar catalogues.</i>  </font>
                                            </div>
                                            <br>
                                        </div>
                                    </div>

                                        <b>Please note: </b> If you select the checkboxes, the system first tries to get both restrictions fulfilled, then only the structure code, afterwards only the phrasegroups and at last no restriction if still no match could be found.
