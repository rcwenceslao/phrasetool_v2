...
if (isset($_POST['phrasegroupEditBtn'])) {
    $pt = new Phrasetool();
    $uid  = $_POST['phrasegroupEditBtn'];
   
    $result = $pt->selectPhraseGroupInfo($uid);
...
if (isset($_POST['updatePhrasegroup']) && $_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $phrasegroup_id = test_input($_POST["phrasegroup_id"]);
  ...
  $uid = (int)$phrasegroup_id;
   ...
   $phrasegroup_fields = [   
       ...
       $pt->updatePhrasegroup($phrasegroup_fields,$uid);
                                ...
                                <div class = "task-progress">
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-12">
                                            <input type="text" class="form-control"  placeholder="Enter Phrasegroup" name="phrasegroup" value="<?php echo $result['phrasegroup']; ?>" required>
                                            

                                          </div>
                                          <?php
                                            echo '<input type="text"  name="phrasegroup_id" placeholder="" class="form-control" value="'.$result['phrasegroupId'].'" hidden>';
                                            ?>
                                        </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <center> 
                                          <div class="col-sm-offset-2 col-sm-12">
                                            <button type="submit" class="btn btn-warning" name="updatePhrasegroup">Submit</button>
                                          </div>
                                        </center>
                                        </div>
                                    </form>
