...
<head>
    ...
    <!-- Title Page-->
    <title>Phrasecatalogue Comparison</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Comparison</li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">PHRASECATALOGUE COMPARISON</li>
                                        </ul>
                                    </div>
                                    <!--
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="statistic__item">
                                    ...
                                    <h2>NEW PHRASEHEAD-PHRASEHEAD-REFERENCE</h2>
                                    <br>
                                    <button type="button" class="btn btn-outline-warning" onclick="showDiv()">Show Catalogue Select</button>
                                    <br><br>
                                        <div class="task-progress" id="hiddenDiv" style="display:none">
                                            <form class="form-horizontal" action="#" >
                                                <div class="container">
                                                 <div class="row">
                                                    <div class="col-md-4">
                                                        <font size="3"> Original Catalogue </font> <br>
                                                         <select name="origcatalogue" class="custom-select mb-3" required>
                                                            <option value="EuPC" selected> EuPC </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <font size="3"> Target Catalogue </font> <br>
                                                         <select name="targetcatalogue" class="custom-select mb-3" required>
                                                            <option value="zzepla" selected> zzepla </option>
                                                            <option value="BDI"> BDI </option>
                                                            <option value="EPOS"> EPOS </option>
                                                            <option value="KRKA"> KRKA </option>
                                                            <option value="ZSM"> ZSM </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <font size="3"> Language </font> <br>
                                                         <select name="language" class="custom-select mb-3" required>
                                                            <option value="en" selected> English - en </option>
                                                        </select>
                                                    </div>
                                                </div> 
                                                Please select two different catalogues which have been mapped against each other before.
                                                <br><br>
                                                <div class="radio" name="catalogue">
                                                  <label><input type="radio" name="norestrictions"> No restrictions</label>
                                                </div>
                                                <div class="radio">
                                                  <label><input type="radio" name="origincatalogue"> Only in Origin Catalogue</label>
                                                </div>
                                                <div class="radio">
                                                  <label><input type="radio" name="differentgroup"> Only with different Groups</label>
                                                </div>
                                                <div class="radio">
                                                  <label><input type="radio" name="differentstructurecode"> Only with different Structure Code</label>
                                                </div>
                                                <div class="radio">
                                                  <label><input type="radio" name="difference"> Only with Differences</label>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class = "task-progress">  
                                    ...
                                    <!-- OUTPUT RESULT HERE FOR SELECT CATALOGUES TO COMPARE -->
