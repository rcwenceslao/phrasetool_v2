...
<head>
    ...
    <!-- Title Page-->
    <title>New Phrasehead-Phrasehead Reference</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <li class="list-inline-item seprate">
                                            ...
                                            <li class="list-inline-item">NEW PHRASEHEAD-PHRASEHEAD-REFERENCE</li>
                                        </ul>
                                    </div>
                                    <!--
                                ...
                                <div class="statistic__item">
                                    ...
                                    <form class="form-horizontal" action="#">
                                     <div class="form-group">
                                          <label class="control-label col-sm-2" for="unnummer"><b>Phrasehead:<font style="color:red;">*</font></b></label>
                                          <div class="col-sm-12">          
                                            <select class= "form-control" name="phrasehead">

                                                <!-- PHRASE HEAD OPTION VALUE FROM DB -->
                                      ...
                                      <div class="form-group">
                                          <label class="control-label col-sm-2" for="unnummer"><b>Ref Phrasenkopf:<font style="color:red;">*</font></b></label>
                                          <div class="col-sm-12">          
                                            <select class= "form-control" name="phrasehead">
