...
<head>
    ...
    <!-- Title Page-->
    <title>Resume Phrase Mapping</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">RESUME PHRASE MAPPING</li>
                                        </ul>
                                    </div>
                                    <!--
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="statistic__item">
                                    ...
                                    <h2>NO FURTHER PROCESSING NEEDED</h2>
                                    <br>
                                    There is no mapping process in the queue. All data was mapped using the automaticmapping process and the manual mapping. Please use another function.
                                </div>
                            </div>
                        </div>
                    </div>
