                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">List Phrase Group</li>
                                        </ul>
                                    </div>
                                    <!--
                                    ...
                                    <div class="table-responsive">
                                     <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $pt = new Phrasetool();
                                                $rowCount = $pt->returnPhrasegroupRowCount();
                                                $rowPerPage = 25;
                                                $numberOfPages = ceil($rowCount / $rowPerPage);
                                                $startingLimitNumber = ($page = 1) * $rowPerPage;

                                                $row = $pt->displayPhraseGroupList($rowPerPage, $startingLimitNumber);
                                                foreach ($rows as $row)
                                                {
                                            ?>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-warning btn-sm">Labelling</button>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td> <button type="button" class="btn btn-warning btn-sm" onclick="location.href='new_phrasegroup.html'"> New Phrasegroup </button> </td>
                                        </tr>
                                        </tbody>
                                      </table>
                                ...
                                <div class="text-center">
                                    <ul class="pagination pagination-lg">
                                        <?php
                                            ...
                                            {
                                                echo "<li><a href = 'list_phrsegroup.php?page=".$page.">".$page."</a></li>";
                                            }
                                        ?>
                                    </ul>
                                </div>
