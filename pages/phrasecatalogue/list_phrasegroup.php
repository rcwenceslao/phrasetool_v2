                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class = "task-progress">
                                    ...
                                    <form action="edit_phrasegroup.php" method="post">
                                     <table class="table table-hover">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <button type="submit" class="btn btn-sm btn-outline-primary" name="phrasegroupEditBtn" value="<?php echo $row['phrasengruppe_id']; ?>">Edit</button>&nbsp;
