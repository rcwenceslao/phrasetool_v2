            ...
            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong><center>PHRASEGROUP</center></strong>
                                        <?php
                                            $pt = new Phrasetool();
                                            $rows = $pt->viewPhraseGroup($phraseGroupID);

                                            foreach ($rows as $row)
                                            {
                                                $phraseGroupID = $row['phrasengruppe_id'];
                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <?php echo $row['phrasengruppe_id']; ?>
                                            </div>
                                            <div class="col-md-6">
                                               Phrasegroup 
                                            </div>
                                            <div class="col-md-6">
                                                <?php echo $row['phrasengruppe']; ?>
                                            </div>
                                            <div class="col-md-6">
                                                Company  
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <?php
                                                            //REMINDER: THE ICONS
                                                                ...
                                                                echo "  <a class='btn btn-warning btn-sm' href=\"#?value=".$phraseGroupID."\"><i class='fa fa-file-text-o' aria-hidden='true'></i>&nbsp;Edit</a>";
                                                        

                                                                echo "  <a class='btn btn-warning btn-sm' href=\"#?value=".$phraseGroupID."\"><i class='fa fa-file-text-o' aria-hidden='true'></i>&nbsp;Labelling</a>";
                                           ...
                                           <div class='col-md-12'>
                                            <h5>Related Phasengrouptexts</h5>
                                            <hr>
                                            <?php 
                                                echo "<a class='btn btn-warning btn-sm' href=\"new_phrasegrouptext.php?value=".$phraseGroupID."\">&nbsp;New Phrasegrouptext</a>";
                                            ?>
                                            <br>
                                        </div> 
                                        </div>
