...
<head>
    ...
    <!-- Title Page-->
    <title>New Phrasegrouptext</title>
                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            <li class="list-inline-item active">
                                                <a href="list_label.html">Phrasegroup List</a>
                                            </li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">Phrasegrouptext</li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">NEW PHRASEGROUPTEXT</li>
                                        </ul>
                                    </div>
                                    <!--
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="statistic__item">
                                    ...
                                    <h2>NEW PHRASEGROUPTEXT</h2>
                                    <br>
                                    Input the following fields to create a new Phrasegrouptext.
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class = "task-progress">
                                   ...
                                   <form class="form-horizontal" action="#">
                                    ...
                                    <?php
                                        $rowsPhrasegroup = $pt->selectPhraseGroup();
                                        $rowCompany = $pt->selectCompany();
                                        $rowLanguage = $pt->selectLanguage();
                                    ?>

                                    <!-- THIS FIELD MUST BE SET -->
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="phraseGroup"><b>Phrasegroup:</b></label>
                                        <div class="col-sm-12">
                                            <select name="phraseGroup" id="phraseGroup" class="form-control">
                                                <?php
                                                    foreach($rowsPhrasegroup as $row)
                                                    {
                                                        echo "<option value=".$row['phrasengruppe_id'].">".$row['phrasengruppe']."</option>";
                                                    }
                                    ...
                                    <!-- THIS FIELD MUST BE SET -->
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="phraseGroupText"><b>Phrasegrouptext:</b></label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="phraseGroupText" placeholder="Enter Phrasegrouptext" name="phraseGroupText">
                                        </div>
                                    </div>
                                    <!-- THIS FIELD MUST BE SET -->
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="language"><b>Language:</b></label>
                                        <div class="col-sm-12">
                                            ...
                                            <?php
                                                    foreach($rowLanguage as $row)
                                                    {
                                                        ...
                                                        echo "<option value=".$row["sprache_id"].">".$row["sprachentext"]."-".$row["sprache_iso2"]."</option>";
                                                    }
                                    ...
                                    <!-- THIS FIELD MUST BE SET -->
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="company"><b>Company</b></label>
                                        <div class="col-sm-12">
                                            <select name="company" id="company" class="form-control">
                                                <?php
                                                    foreach($rowCompany as $row)
                                                    {
