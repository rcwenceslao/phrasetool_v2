...
<head>
    ...
    <!-- Title Page-->
    <title>Phrasecatalogue Export</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">PHRASECATALOGUE EXPORT</li>
                                        </ul>
                                    </div>
                                    <!--
                            ...
                            <div class="col-xl-12">
                                <div class="statistic__item">
                                    ...
                                    <br>
                                        ...
                                        <div class="col-sm-12">
                                                <select name="catalogue" class="custom-select mb-3" required>
                            ...
                            <div class="col-xl-12">
                                <div class = "task-progress">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                                <select name="fileType" class="custom-select mb-3" onchange="java_script_:show(this.options[this.selectedIndex].value)" required>
                                                  <option value="sapexchange" selected>SAP Exchange Format</option>
                                                  <option value="msexcel972003">MS Excel (2007+ / .xlsx) </option>
                                                  <option value="msexcel972003">MS Excel (97 - 2003 / .xls) </option>
                                                </select>
                                            <font size="2"> <i>The download file will be generated in the selected format. If no error occured, the format is identical to the format used by the import functions. Further information on the formats and example files can be found at the documentation / help: <a href="#" style="color: #dea003 "> Help on file formats</a>.</i> </font>
                                        </div>
                                    </div>
                                    <!-- THIS FIELD MUST BE SET -->
                                    <div class="form-group" id="hiddenDiv">
                                        <label class="control-label col-sm-3" for="katalogpin"><b>Target Operating System:</b> <font style="color: red">*</font> </label>
                                        <div class="col-sm-12">
                                                <select name="fileType" class="custom-select mb-3">
                                                  <option value="mswindows" selected>MS Windows or DOS</option>
                                                  <option value="unix">UNIX (incl. Linux, Mac OSX)</option>
                                                  <option value="macos">old Mac OS (up to Max OS9)</option>
                                                </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="alllanguage"><b>All Languages</b></label>
                                              <br>
                                              <font size="2"> <i>If selected, all Phrases in all used languages will be exported.</i>  </font>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <center> 
                                          <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <br>
                                            <font size="3"><b> Please note: </b> You can also export just some selected Phrases. Use the search form for this functionality.</font>
                                          </div>
                                        </center>
                                        </div>
                                   </form>
