...
<head>
    ...
    <!-- Title Page-->
    <title>Phrase Catalogue Import</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Import</li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">PHRASECATALOGUE IMPORT</li>
                                        </ul>
                                    </div>
                                    <!--
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="statistic__item">
                                    ...
                                    <h2>UPLOAD PHRASECATALOGUE</h2>
                                    <br>
                                    <div class="container mt-3">
                                          <form class="form-horizontal" action="#">
                                            <p>File: <font style="color: red">*</font></p>
                            ...
                            <div class="col-xl-12">
                                <div class = "task-progress">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="katalogpin"><b>Type of Upload File:</b> <font style="color: red">*</font> </label>
                                        <div class="col-sm-12">
                                                <select name="fileType" class="custom-select mb-3">
                                                  <option value="sapexchange" selected>SAP Exchange Format</option>
                                                  <option value="msexcelcolumn">MS Excel - different languages in columns (side by side) (xls/xlsx)</option>
                                                  <option value="msexcelrows">MS Excel - different languages in rows (one below the other) (xls/xlsx)</option>
                                                  <option value="euphrac">EuPhraC Download Format (up to version 1.2)</option>
                                                  <option value="separator">Comma Separated Values with separator given below</option>
                                                </select>
                                            <font size="2"> <i>The upload file has to match the selected format other wise the import will fail. <br> Please use the example files for further information on the format of the upload files. You'll find these files in the documentation/ help : <a href="#" style="color: #dea003 "> Help on file formats</a>.</i> </font>
                                        </div>
                                    </div>
                                    <!-- THIS FIELD MUST BE SET -->
                                     <div class="form-group">
                                        <label class="control-label col-sm-3" for="catalogue"><b>Phrasecatalogue:</b><font style="color: red">*</font></label>
                                        <div class="col-sm-12">
                                                <select name="catalogue" class="custom-select mb-3">
                                                    <option value="rimpi" selected> rimpi </option>
                                                    <option value="EuPC"> EuPC </option>
                                                    <option value="zzepla"> zzepla </option>
                                                    <option value="EPOS"> EPOS </option>
                                                    <option value="ACT01"> ACT01 </option>
                                                    <option value="ACT20"> ACT20 </option>
                                                    <option value="eu_phra"> eu_phra </option>
                                                </select>
                                            <font size="2"> <i>You may define a prefix (up to 5 characters) for the PhrasenId. This prefix will be added to all PhrasenIds and may be necessary for use of Phrases in other systems.<br>
                                            The complete PhraseId with the given prefix may not be longer than 15 characters. If you provide a longer combination of Prefix and PhraseId the imported PhraseId will be truncated after 15 characters.</i> </font>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="prefix"><b>Prefix to Phrasen ID:</b></label>
                                        <div class="col-sm-12">
                                                <input type="text" class="form-control" id="prefix" placeholder="Enter separator used" name="prefix">
                                            <font size="2"> <i>You may define a prefix (up to 5 characters) for the PhrasenId. This prefix will be added to all PhrasenIds and may be necessary for use of Phrases in other systems.<br>
                                            The complete PhraseId with the given prefix may not be longer than 15 characters. If you provide a longer combination of Prefix and PhraseId the imported PhraseId will be truncated after 15 characters.</i> </font>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="startingcounter"><b>Starting Counter for Phrase ID:</b></label>
                                        <div class="col-sm-12">
                                                <input type="text" class="form-control" id="startingcounter" placeholder="Enter starting counter" name="startingcounter">
                                            <font size="2"> <i>If you provide a number here, the PhraseId will be serially numbered starting with the value given. This is only valid if no PhraseId is provided by the import file.</i> </font>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="commercialcatalogue"><b>Commercial Catalogue</b></label>
                                              <br>
                                              <font size="2"> <i>If you select this checkbox, the usage of all Phrases in your uploaded file will be restricted to your catalogue, i.e. the will be set to "commercial".<b> <br>Please note: All imported Phrases will be checked against known commercial catalogues and will recieve the commercial flag if tye match known commercial catalogues. </b></i>  </font>
                                            </div>
                                            <br>
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="releasedcatalogue"><b>Released Catalogue</b></label>
                                              <br>
                                              <font size="2"> <i>If you select this checkbox, all Phrases in your uploaded file may be used by other customers. You may get creditpoint for new translations you are uploading.</font>
                                            </div>
                                            <br>
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="overwritephrase"><b>Overwrite Existing, Phrases only</b></label>
                                              <br>
                                              <font size="2"> <i>If you select this checkbox, additionally to an insert also updates will be done on the imported Phrases (including Phraseheads). THis does NOT contain Cataloguedata or Groupdata which not be overwritten.</font>
                                            </div>
                                            <br> 
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="overwritephrase"><b>Overwrite Existing</b></label>
                                              <br>
                                              <font size="2"> <i>If you select this checkbox, additionally to an insert also updates will be done on all imported data (including Cataloguedata and Groupdata).</font>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
