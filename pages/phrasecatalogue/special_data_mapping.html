...
<head>
    ...
    <!-- Title Page-->
    <title>Special Data Mapping</title>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">View Special Data</li>
                                            <li class="list-inline-item seprate">
                                                <span>/</span>
                                            </li>
                                            <li class="list-inline-item">MAPPING OF SPECIAL DATA</li>
                                        </ul>
                                    </div>
                                    <!--
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="statistic__item">
                                    ...
                                    <h2>MAPPING OF SPECIAL DATA</h2>
                                    <br>
                                    All special data will be mapped against the selected target catalogue:
                                </div>
                            </div>
                        </div>
                    </div>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-sm-12">          
                                            <select class= "form-control" name="targetcatalogue" id="targetcatalogue">
                                                ...
                                                <option value="ZKSA">ZKSA</option>
                                                <option value="ZSM">ZSM</option>
                                                <option value="zzepla">zzepla</option>
                                            </select>
                                            <font size="2"> <i>Select your catalogue you want to map the special data with.</i>  </font>
                                           </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="rewritephrasesets"> <b> Add unknown Phrases to target Catalogue</b></label>
                                              <br>
                                              <font size="2"> <i>If checked, unknown Phrases (e.g. not found by search functions) will be added to the target catalogue.</i>  </font>
                                              <br><br>
                                              <label><input type="checkbox" value="rewritespecialdata"> <b> Add non-existing Phrasehead-Phrasehead References</b></label>
                                              <br>
                                              <font size="2"> <i>If checked references for the Phrases to the Phraseset(from TOGS-data table) will be added.</i>  </font>
                                            </div>
                                            <br>
                                        </div>
                                    </div>

                                        <b>Please note: </b> the special data will be mapped in the following way: The Phrase field (of each row) will be read and it will be checked if it contains a Phrasecode. Then the Phrase in a whole will be searched in the target catalogue, afterwards parts of it will be searched.
