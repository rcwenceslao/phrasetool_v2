                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">PHRASESET IMPORT</li>
                                        </ul>
                                    </div>
                                    <!--
                            ...
                            <div class="col-xl-12">
                                <div class = "task-progress">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                                <select name="fileType" class="custom-select mb-3" required>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                                <select name="catalogue" class="custom-select mb-3" required>
                                                    <option value="rimpi"> rimpi </option>
                                                    <option value="EuPC"> EuPC </option>
                                                    <option value="zzepla"> zzepla </option>
                                                    <option value="EPOS"> EPOS </option>
                                                    <option value="ACT01" selected> ACT01 </option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <div class="checkbox">
                                              <label><input type="checkbox" value="commercialcatalogue"><b>Overwrite Existing</b></label>
                                              <br>
                                              <font size="2"> <i>If you select this checkbox, additionally to an insert also updates will be done on all imported data (including Cataloguedata and Groupdata).</i>  </font>
                                            </div>
                                            <br>
                                        </div>
                                    </div>
