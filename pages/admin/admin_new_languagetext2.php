...
/*if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $Language = test_input($_POST["languageSelected"]);
    $displayLanguage = test_input($_POST["displayLanguageSelected"]);
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <div class="btn-group">
                                                        <div class="col-12 col-md-12">
                                                                <!-- <?php
                                                                $rowLanguage = $pt->displayLanguageTextValues();
                                                                ?>
                                                                <select name="displayLanguageSelected" id="select" class="form-control">
                                                                    <?php foreach ($rowLanguage as $rowLanguage) { ?>
                                                                    <option value="<?php echo $rowLanguage['languageId'];?>"><?php echo $rowLanguage['language']; ?></option>
                                                                    <?php 
                                                                }
                                                                ?> -->
                                                            </select>
                                             ...
                                             <br>
                                             <button type="submit" class="btn btn-success btn-sm" name="addLanguageText">
