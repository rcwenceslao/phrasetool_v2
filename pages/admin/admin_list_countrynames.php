        ...
        <div class="page-container2">
            ...
            <center>
                <div class="col-lg-12">
                  ...
                  <thead>
                    <tr>
                      <th scope="col" class="table-warning">Country</th>
                      <th scope="col" class="table-warning">Language</th>
                      <th scope="col" class="table-warning">Countryname</th>
                      <th scope="col" class="table-warning" width="30%">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                        $pt = new Phrasetool();
                        $rows = $pt->displayCountryNames();
                        foreach ($rows as $row) 
                        {
                    ...
                    ?>
                            ...
                            <td><a class="btn btn-sm btn-outline-primary" href=""><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Edit</a>&nbsp;<a class="btn btn-sm btn-outline-danger" href=""><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;Delete</a>&nbsp;<a  class="btn btn-sm btn-outline-success" href=""><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;View</a></td>
                            </tr>
                    <?php
                        }
