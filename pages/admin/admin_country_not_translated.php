                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="has-sub">
                         ...
                         <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="as fa-quote-left"></i>Phrasetext
                                <span class="arrow">
                                    <i class="fas fa-angle-down"></i>
                                </span>
                            </a>
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Missing Translations of Country Names</li>
                                        </ul>
                                    </div>
                                    <!--
                ...
                <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        Countrynames not translated into your language
                                    </div>
                                    <div class="card-body card-block">
                                       ...
                                       <div class = "task-progress">
                                        ...
                                        <?php
                                            ...
                                            $pt = new Phrasetool();
                                                $rowCount = $pt->returnCountryNotTranslatedCount(); //return number of rows in db
                                                $rowPerPage = 50; //number of rows per page
                                                $numberOfPages = ceil($rowCount / $rowPerPage); //number of pages
                                                $startingLimitNumber = ($page - 1) * $rowPerPage; //limit number


                                            $rows = $pt->displayCountryNotTranslated($page, $startingLimitNumber);
                                            foreach ($rows as $row) 
                                            {
                                        ...
                                        $rows2 = $pt->displayCountry($row['land_id']);

                                        foreach ($rows2 as $row2)
                                        {
                                            echo $row2['landesname'];
                                        }
                                        ?></th>
                                        <td><?php echo $row['iso2_code']; ?></td>
                                        <td><?php echo $row['sap_code']; ?></td>
                                        <td><a class="btn btn-sm btn-outline-primary" href="edit_phrasehead.php?id=<?php //echo $row['firma_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Translate</a></td>
                                        </tr>
                                    ...
                                    <div class="col-md-12">
                                     <div class="text-center">
                                        ...
                                        <?php
                                            ...
                                            {
                                                echo '<li><a href = "admin_country_not_translated.php?page='.$page.'">'. $page .'</a></li>';
                                            }
                                        ?>
                                    </ul>
                                    </div>
