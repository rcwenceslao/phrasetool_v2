...
if(isset($_GET['read']))
{
    ...
    $result = $pt->viewUserTranslationsPerMonth($uid);
}
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Credit Point</li>
                                        </ul>
                                    </div>
                                    <!--
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <?php echo $result['vorname']; ?>
                                            </div>
                                            <div class="col-md-6">
                                               Salutation
                                            </div>
                                            <div class="col-md-6">
                                                <?php echo $result['anrede']; ?>
                                            </div>
                                            <div class="col-md-6">
                                                Title
                                            </div>
                                            <div class="col-md-6">
                                                <?php echo $result['titel']; ?>
                                            </div>
                                            <div class="col-md-6">
                                               Prename
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <?php echo $result['nachname']; ?>
                                            </div>
                                            <div class="col-md-6">
                                                Company
                                            </div>
                                            <div class="col-md-6">
                                                <?php echo $result['firma_text']; ?>
                                            </div>
                                            <div class="col-md-6">
                                                Department
                                            </div>
                                            <div class="col-md-6">
                                                <?php echo $result['abteilung']; ?>
                                            </div>
                                            <div class="col-md-6">
                                                Street
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <?php 
                                                $emailVerification = $result['email_pruef']; 
                                            ...
                                            <div class="col-md-6">
                                                Show all Languages while Translating
                                            </div>
                                            <div class="col-md-6">
                                                 <?php 
                                                $showLanguage = $result['email_pruef']; 
                                                if($showLanguage == 1)
                                                {
                                                    $showAll = "Yes (X)";
                                                }
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-body card-block">
                                                ...
                                                <div class = "task-progress">
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-sm"><a href="admin_company_info.html" style="color: black;"> View</button>
