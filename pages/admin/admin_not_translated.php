                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Missing Translations of Countrynames</li>
                                        </ul>
                                    </div>
                                    <!--
                ...
                <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        Missing Translations of Language Texts
                                    </div>
                                    <div class="card-body card-block">

                                       <div class = "task-progress">
                                        <h2 style="margin-top:-1em;">Language</h2><br>
                                        ...
                                        <?php
                                            ...
                                            $rowCount = $pt->returnNotTranslated(); //return number of rows in db
                                            ...
                                            $rows = $pt->displayNotTranslatedLanguages($rowPerPage, $startingLimitNumber);
                                            foreach ($rows as $row) 
                                            {
                                        ...
                                        <td><a name="languageIDD" class="btn btn-sm btn-outline-primary" href="admin_new_languagetext.php?read=<?php echo $row['sprache_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Translate </a></td>
                                        </tr>
                                    ...
                                    <div class="col-md-12">
                                     <div class="text-center">
                                        ...
                                        <?php
                                            ...
                                            {
                                                echo '<li><a href = "admin_not_translated.php?page='.$page.'">'. $page .'</a></li>';
                                            }
                                        ?>
                                    </ul>
                                    </div>
