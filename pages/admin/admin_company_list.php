                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">List Companys</li>
                                        </ul>
                                    </div>
                                    <!--
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <?php
                                            ...
                                            //display pagination
                                            $rowCount = $pt->returnPhrasegroupRowCountCompany(); //return number of rows in db
                                            ...
                                            $rows = $pt->displayCompanyList($rowPerPage,$startingLimitNumber);
                                        ...
                                        <tr>
                                        <th scope="row"><?php echo $row['firma']; ?></th>
                                        <td><?php echo $row['strasse1']; ?></td>
                                        <td><?php echo $row['PLZ']; ?></td>
                                        <td><?php echo $row['telefon']; ?></td>
                                        <td><?php echo $row['telefax']; ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-outline-primary" href="edit_phrasehead.php?id=<?php echo $row['firma_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Edit</a>&nbsp;
                                            <a class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#deletePhraseHead" href="#"><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;Delete</a>&nbsp;
                                            <a  class="btn btn-sm btn-outline-success" href="admin_company_info.php?read=<?php echo $row['firma_id']; ?>"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;View</a>
                                        </td>
                                        </tr>
                                    ...
                                    <div class="col-md-12">
                                     <div class="text-center">
                                        ...
                                        <?php
                                            ...
                                            {
                                                echo '<li><a href = "admin_company_list.php?page='.$page.'">'. $page .'</a></li>';
                                            }
                                        ?>
                                    </ul>
                                    </div>
